        ...
        <div class="grid grid-cols-1 lg:grid-cols-2">
            <div class="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                    ...
                    <h2 class="text-3xl font-bold leading-tight text-black sm:text-4xl mt-4">Create an account</h2>
                    <!-- form -->
            ...
            <div class="flex items-center justify-center px-4 py-10 sm:py-16 lg:py-24 bg-gray-50 sm:px-6 lg:px-8">
                <div>
                    <img class="w-full lg:width-4000px mx-auto py-4" src="assets/svgs/fi-hriss.svg"  alt="" />
    
                    <div class="w-full max-w-md mx-auto xl:max-w-xl">
                        <h1 class="text-5xl font-bold text-center text-dark">Welcome To HumanSpace!</h1>
                        <p class="leading-relaxed text-center text-gray-500 mt-2.5 sm:mt-4">Your partner for simplify your human resources system.</p>
                    </div>
                </div>
