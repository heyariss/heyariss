    ...
    <div class="grid grid-cols-1 lg:grid-cols-2">
        <div class="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
            <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                <img src="/assets/svgs/logo-typemdpi.svg" action="index" width="200px" alt="">
                <div class="text-[32px] font-semibold text-dark mt-[48px]">
                Sign In
                </div>
                <p class="mt-2 text-base leading-7 mb-[24px] text-grey">
                Manage your employees to achieve a bigger goals for your company.
                </p>
                ...
                <!-- mengarah ke file register -->
                <p class="mt-2 text-base text-grey">Dont have an account? <a href="register" title="" class="font-medium text-blue-600 transition-all duration-200 hover:text-blue-700 hover:underline focus:text-primary">Create a free account</a></p>
        ...
        <div class="flex items-center justify-center px-4 py-10 sm:py-16 lg:py-24 bg-gray-50 sm:px-6 lg:px-8">
            <div>
                <img class="w-full max-w-md mx-auto" src="/assets/svgs/fi-hriss.svg" alt="" />

                <div class="w-full max-w-md mx-auto xl:max-w-xl">
                    <h2 class=" text-5xl font-bold text-center text-black mt-4">Welcome To HumanSpace</h2>
                    <p class="leading-relaxed text-center text-gray-500">Securing employee data to streamline the entire HR lifecycle, team management and employee analytics, This is an Human Resouces Information System Apps</p>

                    <!-- <div class="flex items-center justify-center mt-10 space-x-3">
                        <div class="bg-primary rounded-full w-20 h-1.5"></div>
